...
DEVICE_LABEL = "KEYO_HOCAGEE"  # Replace by your desired device label
VARIABLE_LABEL = "sensor_pir_1"  # Replace by your desired counter variable label
UBIDOTS_TOKEN = "BBFF-jcfRyvt4CCMMhDQpZNm5XNFkdHONjH"  # Add here your Ubidots token
